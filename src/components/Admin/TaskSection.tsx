        ...
        <div className="p-10 space-y-5 w-full">
            ...
            <div className="flex gap-5">
                <div className="w-[80%] space-y-5">
                    ...
                    {/* Add new Module */}
                    <div
                        className="border rounded-lg border-gray-500 p-2 hover:border-green-600 hover:text-green-600  text-gray-500 transition-all duration-200 ease-in-out flex justify-center items-center flex-col h-24 hover:cursor-pointer"
                        onClick={() => onAddNewModule(data?.id)}
                    >
